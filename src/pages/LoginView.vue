...
import RegisterFormMolecule from '@/components/molecules/RegisterFormMolecule.vue';
import GoogleSigninButtonAtom from '@/components/atoms/button/GoogleSigninButtonAtom.vue';
export default {
  name: "LoginView",
  data() {
    return {
