<template>
  <div
    v-if="splitPage() > 1"
    class="flex justify-center items-center text-sm md:text-lg [&>*]:w-7 [&>*]:h-7 md:[&>*]:w-10 md:[&>*]:h-10 [&>*]:border [&>*]:justify-center [&>*]:items-center hover:[&>*]:border-green-700 hover:[&>*]:text-green-700"
  >
  ...
  methods: {
    ...
    formatPanigation(pageNumber) {
      ...
      if (this.currentPage === pageNumber) {
        style = "text-green-700 border-green-700";
      }
      if (
